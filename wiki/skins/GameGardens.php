<?php
/**
 * GameGardens themey theme-opolis
 *
 * @package MediaWiki
 * @subpackage Skins
 */
 ...
 * @subpackage Skins
 */
class SkinGameGardens extends SkinTemplate {
    /** Using monobook. */
 ...
 * @subpackage Skins
 */
class GameGardensTemplate extends QuickTemplate {
    /**
     * Template filter callback for GameGardens skin.
...
<?php       }
        ...
        wfRunHooks( 'GameGardensTemplateToolboxEnd', array( &$this ) );
?>
            </ul>
        </div>
    </div>
...
<div class="ggfooter">
  <a href="/">Game Gardens</a>:
  <a href="/gardens/browse.wm">Games</a> |
