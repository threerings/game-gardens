...
abstract class OptionalUserLogic extends Logic {
  ...
  /** Logic classes should implement this method to perform their normal duties.
    ...
    * @param user the user record for the authenticated user or null if no user is authenticated.
    */
