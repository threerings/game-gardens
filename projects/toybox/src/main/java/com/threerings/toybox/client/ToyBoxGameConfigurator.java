...
/**
 * Handles the configuration of a ToyBox game. This works in conjunction with the {@link
 * ToyBoxGameConfig} to provide a generic mechanism for defining and obtaining game configuration
 * settings.
 */
public class ToyBoxGameConfigurator extends SwingGameConfigurator
{
    ...
    protected ParamEditor createEditor (ToyBoxContext ctx, MessageBundle msgs, Parameter param)
    {
